...
class Company extends CI_Controller{
	...
	function update(){
		...
		if(!empty($foto)){
			...
			echo $sql= "UPDATE data_company SET website='$website',nama='$nama',deskripsi='$deskripsi',tlp='$tlp',alamat='$alamat',email='$email',warna_utama='$warna_utama',warna_kedua='$warna_kedua',warna_ketiga='$warna_ketiga' WHERE id='$id'";
		}
