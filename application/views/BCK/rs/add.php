...
date_default_timezone_set('Asia/Jakarta');
    	  			...
    	  			<?php 
        			   ...
        			   <select  name="<?php echo $col->Field ?>" class="form-control selectza">
        			       <option></option>
        			       <option>Berhasil Terkirim</option>
        			       <option>Kembali POS</option>
        			  ...
        			  <?php 
    	  			    }elseif($col->Field=="filepdf_$modul"){
    	  			        ?>
        			    ...
        			    <input type="file" name="filepdf_<?php echo $modul ?>" class="form-control" />
        		     </div>
