 ...
 <div class="bg-white row" style="margin-top:0%;margin-bottom:2%">
     <div class="col col-sm-2">
         <a href="<?php echo site_url() ?>" class="btn bg-white text-black col col-sm-12"><i class="flaticon2-left-arrow-1"></i> Back</a>
	  	...
	  	<table class="table table-bordered table-striped table-hover tabza display"  style="width:100%">
	  		...
	  		<tbody>
	  				...
	  				<?php
	  				$no=0;
	                $sql = "SELECT * FROM data_$modul a JOIN data_siswa b ON a.fid_siswa = b.id_siswa";
		...
		<td><?php echo $row->rekomendasi ?></td>
		  				 ...
		  				 <a href="<?php echo site_url($modul.'/print/'.$row->{'id_' . $modul}) ?>" class="btn bg-utama"><i class="flaticon-search"></i> Detail</a>
		  				 
		  					<a href="<?php echo site_url($modul.'/edit/'.$row->{'id_' . $modul}) ?>" class="btn bg-kedua"><i class="flaticon-edit"></i> Edit</a>
