	...
	<div class="card">
	  ...
	  <div class="card-body">
	  	...
	  	<table class="table table-bordered table-striped table-hover tabza">
	  		<thead>
	  			<tr class="bg-utama" style="color:white">
	  			<th>No</th>
	  			<th>username</th>
	  			<th>password</th>
	  			<th>Nama Lengkap</th>
	  		...
	  		<tbody>
		  		...
		  		?>
		  			<tr>
		  				...
		  				<td>
		  					<a href="<?php echo site_url('users/detail/'.$row->id) ?>" class="btn bg-utama"><i class="flaticon-eye"></i></a>

		  					<a href="<?php echo site_url('users/edit/'.$row->id) ?>" class="btn bg-kedua"><i class="flaticon-edit"></i></a>

		  					<a onClick="return confirm('Apakah anda akan hapus ini ?')" href="<?php echo site_url('users/delete/'.$row->id) ?>" class="btn bg-ketiga"><i class="flaticon-delete"></i></a>	
		  				</td>
		  			</tr>
