        			...
        			<?php echo ucfirst(str_replace("_"," ",$col->Field)) ?> 
        			  ...
        			  <?php 
        			   ...
        			   <select  name="<?php echo $col->Field ?>" class="form-control selectza">
        			       ...
        			       <option <?php echo $data->{$col->Field}=="Hadir"?"selected":"" ?> >Hadir</option>
        			       <option <?php echo $data->{$col->Field}=="Izin"?"selected":"" ?> >Izin</option>
        			       <option <?php echo $data->{$col->Field}=="Sakit"?"selected":"" ?> >Sakit</option>
        			       <option <?php echo $data->{$col->Field}=="Alfa"?"selected":"" ?> >Alfa</option>
