  	...
  	<button class="btn bg-utama" type="SUBMIT"><i class="flaticon2-files-and-folders"></i> Simpan</button>
    	...
    	<?php 
        			...
        			<?php echo ucfirst(str_replace("_"," ",$col->Field)) ?> 
        			  ...
        			  <?php 
    	  			    }elseif($col->Field=="file_ttd"){
    	  			        ?>
    	  			        
    	
        			    <input type="hidden" name="file_ttd_old" class="form-control" value="<?php echo $data->{$col->Field} ?>" />
        			...
        			<?php echo ucfirst(str_replace("_"," ",$col->Field)) ?> 
        			  ...
        			  <?php 
        			   ...
        			   <select  name="<?php echo $col->Field ?>" class="form-control selectza">
        			       <option <?php echo $data->{$col->Field}=="Dalam"?"selected":"" ?>>Dalam</option>
        			       <option <?php echo $data->{$col->Field}=="Luar"?"selected":"" ?>>Luar</option>
